...
#         )
        ...
        train_dataset = gdata.VOCDetection(root='/opt/ml/code/data-0/VOCdevkit/',
            splits=[(2007, 'trainval'), (2012, 'trainval')])
        val_dataset = gdata.VOCDetection(root='/opt/ml/code/data-0/VOCdevkit/',
            splits=[(2007, 'test')])
    ...
    def conv_nets():
        net = model_zoo.get_model('faster_rcnn_resnet101_v1d_coco', pretrained_base=False)
        return net
